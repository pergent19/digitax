        ...
        <div className="transactions-section">
            <nav id="navbar">
                ...
                <ul className="nav-menu">
                    ...
                    <li><a href="#service" className="scroll">Transactions</a></li>
                    <li><a href="#menu" className="scroll">Information</a></li>
                </ul>
            </nav>
            <div className="row mt-2">
                <div className="col-md-3 offset-1">
                    <form encType="multipart/form-data" className="d-flex">
                        <button type="submit" className="search-button mr-2"> <i class="fas fa-search"></i></button>
